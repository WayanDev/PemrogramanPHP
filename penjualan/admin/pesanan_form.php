...
<form action="pesanan_controller.php" method="post">
      ...
      <div class="form-group row">
        ...
        <div class="col-8">
          <input id="total" name="total" value="<?= $pesanan['total'] ?>" type="text" class="form-control">
        </div>
      </div>
      <div class="form-group row">
        <label for="text1" class="col-4 col-form-label">Pelanggan ID</label> 
        <div class="col-8">
          <input id="pelanggan_id" value="<?= $pesanan['pelanggan_id'] ?>" name="pelanggan_id" type="text" class="form-control">
        </div>
      </div>
      <div class="form-group row">
        <div class="col-8">
